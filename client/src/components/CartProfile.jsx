...
export default function CartProfile() {
    ...
    return (
        ...
        <div>
<div className="cart99" style={{ width: "500px" }}>
<div className="stephane">
<img className="stephaneimg" src="https://www.legalmedcard.com/wp-content/uploads/2019/06/doctor-img-01-free-img.jpg" alt="Card image"  />
<br /> <br /> <br /><br />
  <h4 className="card-titl">dr.stephane </h4>
  <br /><br />
  <a className="ediProfile">edit Profile</a>
  <br /><br /><br /><br />
  <h3 className='rates'>150 Rates</h3>
  <br />
